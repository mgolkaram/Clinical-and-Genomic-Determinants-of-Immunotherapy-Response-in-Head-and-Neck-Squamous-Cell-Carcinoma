...
colnames(df)[colnames(df)=='GENDER']<-'Sex'
...
train.idx<-read.csv('~/PATH2FILE/H&N/training.csv')$x
test.idx<-read.csv('~/PATH2FILE/H&N/test.csv')$x
#test.idx<-train.idx
...
test.set<-read.csv('~/PATH2FILE/H&N/IMPACT-validation.csv',stringsAsFactors = F)
...
clin.fac1<-test.set
clin.fac1$RF14<-x
clin.fac1$BEST_RESPONSE<-as.factor(ifelse(read.csv('~/PATH2FILE/H&N/IMPACT-validation.csv')$BEST_RESPONSE=='CR' | read.csv('~/PATH2FILE/H&N/IMPACT-validation.csv')$BEST_RESPONSE=='PR', 1,0 ))
RRF14<-as.numeric(roc( clin.fac1$BEST_RESPONSE,clin.fac1$RF14,smoothed = TRUE)$auc)
RTMB<-as.numeric(roc( clin.fac1$BEST_RESPONSE,clin.fac1$nonsyn.TMB,smoothed = TRUE)$auc)

clin.fac1$Overall_Survival_Event<-read.csv('~/PATH2FILE/H&N/IMPACT-validation.csv')$Overall_Survival_Event
clin.fac1$OS<-read.csv('~/PATH2FILE/H&N/IMPACT-validation.csv')$OS*30
clin.fac1$Progression<-read.csv('~/PATH2FILE/H&N/IMPACT-validation.csv')$Progression
clin.fac1$PFS<-read.csv('~/PATH2FILE/H&N/IMPACT-validation.csv')$PFS*30
